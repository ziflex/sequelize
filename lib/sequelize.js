...
module.exports = (function() {
  ...
  */
  var Sequelize = function(database, username, password, options) {
    ...
    try {
      var Dialect = Sequelize.Dialects[this.getDialect()]();
  ...
  Sequelize.Dialects = {
    'mariadb' : function() { return require('./dialects/mariadb'); },
    'mssql': function() { return require('./dialects/mssql'); },
    'mysql': function() { return require('./dialects/mysql'); },
    'postgres' : function() { return require('./dialects/postgres'); },
    'sqlite'  : function() { return require('./dialects/sqlite'); }
  };
